// pages/api/login.js
import { AUTHENTICATE, GET_USER_BY_USERNAME } from "@/server/REST_API_Const";
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    // Forward the login request to your authentication service
    const response = await axios.post(AUTHENTICATE, req.body);
