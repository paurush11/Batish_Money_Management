...
export const AddBillsSidebar: React.FC<IAddBillSidebar> = ({
  ...
  return (
    <div className="flex w-72 flex-col space-y-5">
      ...
      <Button variant={dueDateHasValue ? "correct" : "default"}>
        Due Date
      </Button>
      <Button variant={frequencyHasValue ? "correct" : "default"}>
        Frequency
      </Button>
      <Button variant={categoryHasValue ? "correct" : "default"}>
        Category
      </Button>
      <Button variant={paymentStatusHasValue ? "correct" : "default"}>
        Payment Status
      </Button>
      <Button variant={paymentMethodHasValue ? "correct" : "default"}>
        Payment Method
      </Button>
      <Button variant={attachmentHasValue ? "correct" : "default"}>
        Notes
      </Button>
      <Button variant={notesHasValue ? "correct" : "default"}>
        Attachments
      </Button>
    </div>
  );
