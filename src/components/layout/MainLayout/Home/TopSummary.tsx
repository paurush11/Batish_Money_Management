...
import { ITopSummary } from "../../../../lib/Interfaces";
  ...
  return (
    <div className="flex flex-1 items-center justify-center">
      <Card className="flex h-full flex-1 flex-col">
        ...
        <CardContent className="flex h-full w-full">
          ...
          >
            {!collapsed ? (
              ...
              <RadarChart cx="55%" cy="50%" outerRadius="80%" data={catData}>
                <PolarGrid />
        ...
        <CardFooter>
          <p>
            Analyze your top expenses to make sure to understand where your
            money goes{" "}
          </p>
        </CardFooter>
      </Card>
